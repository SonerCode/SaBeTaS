...
class AksamL extends StatefulWidget {
  AksamL({super.key, required this.diyetisyenuid});
  String diyetisyenuid;

  @override
  // ignore: library_private_types_in_public_api
  _AksamLState createState() => _AksamLState();
}

class _AksamLState extends State<AksamL> {
  @override
  void initState() {
    super.initState();
    Provider.of<FireFood>(context, listen: false)
        .foodgetirAksam(diyetisyenuid: widget.diyetisyenuid);
  }
          ...
          children: [
            ...
            Padding(
              ...
              child: Container(
                ...
                height: value.aksamList!.length * 70000 / heig,
                alignment: Alignment.center,
                padding: const EdgeInsets.all(10),
                child: ListView.separated(
                  itemCount: value.aksamList!.length,
                  itemBuilder: (context, index) {
                    return AteFoodsItem(
                        food: value.aksamList![index], ogun: 'aksam');
                  },
